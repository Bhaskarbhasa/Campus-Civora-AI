...
- **??? Multi-Tier RBAC:** Granular Role-Based Access Control supporting 14+ specific roles (Students, Faculty, Class Advisors, Wardens, Chief Wardens, Maintenance Supervisors, Directors, etc.).
- **?? Digital Petitions:** A democratic polling system allowing students to gather signatures for policy changes. If a petition hits 30% student support, it automatically forces an official response from Deans.
- **??? Semantic Duplicate Detection:** The AI scans recent database entries to identify and merge duplicate complaints in the same building, preventing technician overload.
